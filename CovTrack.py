...
def covid_tracker():
    ...
    global search_label
    search_label = tk.Label(frame, bd=5, font=('Helvetica', 15, 'bold'),
                            anchor='nw', justify='center', fg='#00948f', text="Enter Location")
...
def get_covid_data(city):
    ...
    return f"""
      ...
      -> New cases: {data[state][1]}
      -> Cases per million:  {data[state][2]}
      -> Deaths: {data[state][3]}
          """
...
def symptoms_checker():
    ...
    label = tk.Label(bottom_frame, bd=2, bg='#ff8787', font=(
        'Helvetica', 13, 'bold'), anchor='nw', justify='left', fg='#00827e')
    label.place(relx=0.05, rely=0.05, relheight=0.9, relwidth=0.9)

    # List of Different Symptoms Checkboxes

    fever_button = tk.Checkbutton(bottom_frame, selectcolor="green", onvalue=1, offvalue=0, text="Fever",
                                  bd=2, bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[0])
    fever_button.place(relx=0.1, rely=0.1, relheight=0.1, relwidth=0.24)

    cough_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Dry Cough", bd=2,
                                  bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[1])
    cough_button.place(relx=0.4, rely=0.1, relheight=0.1, relwidth=0.24)

    tiredness_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Tiredness",
                                      bd=2, bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[2])
    tiredness_button.place(relx=0.7, rely=0.1, relheight=0.1, relwidth=0.24)

    aches_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Aches & Pain", bd=2,
                                  bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[3])
    aches_button.place(relx=0.1, rely=0.23, relheight=0.1, relwidth=0.24)

    throat_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Sore throat", bd=2,
                                   bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[4])
    throat_button.place(relx=0.4, rely=0.23, relheight=0.1, relwidth=0.24)

    diarrhoea_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Diarrhoea",
                                      bd=2, bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[5])
    diarrhoea_button.place(relx=0.7, rely=0.23, relheight=0.1, relwidth=0.24)

    conjunctivitis_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Conjunctivitis",
                                           bd=2, bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[6])
    conjunctivitis_button.place(
        relx=0.1, rely=0.36, relheight=0.1, relwidth=0.24)

    headache_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Headache", bd=2,
                                     bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[7])
    headache_button.place(relx=0.4, rely=0.36, relheight=0.1, relwidth=0.24)

    loss_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Loss of taste", bd=2,
                                 bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[8])
    loss_button.place(relx=0.7, rely=0.36, relheight=0.1, relwidth=0.24)

    rashes_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Rashes", bd=2,
                                   bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[9])
    rashes_button.place(relx=0.1, rely=0.36, relheight=0.1, relwidth=0.24)

    chest_button = tk.Checkbutton(bottom_frame, selectcolor="green", text="Chest Pain", bd=2,
                                  bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), variable=selections[10])
    chest_button.place(relx=0.4, rely=0.49, relheight=0.1, relwidth=0.24)

    submit_button = tk.Button(bottom_frame, text="Submit", bd=2, bg='#c20000', fg='#fffcfc', font=(
        'Helvetica', 14, 'bold'), command=calculate_case)
...
def calculate_case():
    ...
    search_label = tk.Label(frame, bd=0, font=('Helvetica', 15, 'bold'),
                            anchor='nw', justify='center', fg='#fffcfc', bg='#9e0000', text="Result")
    ...
    label = tk.Label(bottom_frame, bd=2, bg='#fffcfc', font=(
        'Helvetica', 12, 'bold'), anchor='nw', justify='left', fg='#c20000')
    label.place(relx=0.05, rely=0.05, relheight=0.9, relwidth=0.9)
    ...
    """
        ...
        next_button = tk.Button(bottom_frame, bd=3, text="Next", font=(
            'Helvetica', 13, 'bold'), bg='#c20000', fg='#fffcfc', command=toll)
...
def toll():
    ...
    search_label = tk.Label(frame, bd=0, font=('Helvetica', 15, 'bold'), anchor='nw',
                            justify='center', fg='#fffcfc', bg='#9e0000', text="Toll Free Numbers")
  ...
  """
    next_button2 = tk.Button(bottom_frame, bd=3, text="Next", font=(
        'Helvetica', 13, 'bold'), bg='#c20000', fg='#fffcfc', command=toll2)
...
def precaution():
    ...
    search_label = tk.Label(frame, bd=0, font=('Helvetica', 16, 'bold'), anchor='nw',
                            justify='center', fg='#fffcfc', bg='#9e0000', text="Precautions")
...
def menu():
    ...
    heading_label = tk.Label(root, bd=3, text="CovTrack",
                             bg='#dbd9d9', fg='#c20000', font=('Helvetica', 20, 'bold'))
    ...
    global search_label
    search_label = tk.Label(frame, bd=0, font=('Helvetica', 15, 'bold'),
                            anchor='nw', justify='center', fg='#fffcfc', bg='#9e0000', text="MENU")
    ...
    tracker_button = tk.Button(bottom_frame, text="COVID Cases Tracker", bd=2, bg='#c20000',
                               fg='#fffcfc', font=('Helvetica', 14, 'bold'), command=covid_tracker)
    tracker_button.place(relx=0.1, rely=0.1, relheight=0.15, relwidth=0.8)

    symptoms_button = tk.Button(bottom_frame, text="Symptoms Checker", bd=2, bg='#c20000', fg='#fffcfc', font=(
        'Helvetica', 14, 'bold'), command=symptoms_checker)
    symptoms_button.place(relx=0.1, rely=0.3, relheight=0.15, relwidth=0.8)

    precaution_button = tk.Button(bottom_frame, text="Precautionary Measures", bd=2,
                                  bg='#c20000', fg='#fffcfc', font=('Helvetica', 14, 'bold'), command=precaution)
    precaution_button.place(relx=0.1, rely=0.5, relheight=0.15, relwidth=0.8)

    exit_button = tk.Button(bottom_frame, text="Exit", bd=2, bg='#c20000', fg='#fffcfc', font=(
